<div class="text-center">
 ...
 ╚══════╝╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═══╝ ╚═════╝
    ...
    <h1 class="text-4xl sm:text-5xl font-bold mb-3"><?= e(config('app.name')) ?></h1>
    <p class="text-slate-400 text-base sm:text-lg mb-8">Your project is ready. Start building with ZeroPing.</p>
