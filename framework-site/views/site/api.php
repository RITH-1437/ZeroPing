...
<section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" data-animate>
    ...
    <p class="mt-4 text-zp-desc">The core classes, methods, and namespaces that power everyday ZeroPing development. Each entry links to deeper documentation.</p>

    <!-- Namespaces -->
    <div class="mt-14">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-zp-link">Namespaces</h2>
        <p class="mt-3 text-sm text-zp-desc max-w-3xl">ZeroPing organizes code under the <code class="px-1.5 py-0.5 rounded bg-zp-surface border border-zp-border text-zp-ink">App\Core</code> root namespace, with framework utilities nested by responsibility.</p>
        ...
        <div class="mt-5 grid gap-4">
            ...
            $classes = [
                [
                    ...
                    'desc' => 'Registers and resolves application routes.',
                    'methods' => [
                ...
                [
                    ...
                    'desc' => 'Active-record base class for database entities.',
                    'methods' => [
                ...
                [
                    ...
                    'desc' => 'Stateless and session-based authentication helpers.',
                    'methods' => [
                ...
                [
                    ...
                    'desc' => 'Validates input against rule strings or arrays.',
                    'methods' => [
                ...
                [
                    ...
                    'desc' => 'Key-value caching with multiple stores.',
                    'methods' => [
                        ...
                        <div class="grid md:grid-cols-2 gap-x-8 gap-y-3">
                            <?php foreach ($c['methods'] as $m): ?>
                                <div class="flex flex-col">
                                    ...
                                    <span class="mt-1.5 text-xs text-zp-desc"><?= htmlspecialchars($m['desc'], ENT_QUOTES, 'UTF-8') ?></span>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
    ...
    <div class="mt-16 pt-16 border-t border-zp-border">
        ...
        <p class="mt-3 text-sm text-zp-desc max-w-3xl">Copy-ready snippets for the most common API surfaces.</p>
        <?php
        $groups = [
            'Routing' => [
