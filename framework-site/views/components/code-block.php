...
$titleBadge = ($title && $title !== 'Code')
    ...
    : '';
?>
<section class="code-block mt-6 rounded-2xl overflow-hidden shadow-xl <?= $widthClass ?>" style="opacity:1;filter:none;backdrop-filter:none;background:#08120D;border:1px solid #1F3B2D;">
