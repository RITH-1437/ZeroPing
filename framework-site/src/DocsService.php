...
class DocsService
{
    ...
    private array $documents = [
        ...
        [
            'slug' => 'routing',
            'title' => 'Routing',
            'description' => 'Route registration, parameters, named routes, groups, and caching.',
            'file' => 'routing.md',
        ],
        [
            'slug' => 'middleware',
            'title' => 'Middleware',
            'description' => 'Creating, registering, and using middleware in ZeroPing.',
            'file' => 'middleware.md',
        ],
        [
            'slug' => 'authentication',
            'title' => 'Authentication',
            'description' => 'Session-based auth, AuthManager, password hashing, and reset flows.',
            'file' => 'authentication.md',
        ],
        [
            'slug' => 'events',
            'title' => 'Events',
            'description' => 'Creating events and listeners, dispatching, and priority handling.',
            'file' => 'events.md',
        ],
        [
            'slug' => 'mail',
            'title' => 'Mail',
            'description' => 'Mailable classes, drivers, sending mail, and testing.',
            'file' => 'mail.md',
        ],
        [
            'slug' => 'filesystem',
            'title' => 'Filesystem',
            'description' => 'Disks, reading and writing files, uploads, and the storage() helper.',
            'file' => 'filesystem.md',
        ],
        [
            'slug' => 'helpers',
            'title' => 'Helper Functions',
            'description' => 'All 30+ global helper functions grouped by category.',
            'file' => 'helpers.md',
        ],
        [
            'slug' => 'localization',
            'title' => 'Localization',
            'description' => 'Language files, trans() helper, placeholders, and locale switching.',
