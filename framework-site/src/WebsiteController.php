 ...
 *
 * This controller (and the whole framework-site/ tree) lives OUTSIDE the core
 * framework. It is only loaded when the repository itself is run. Generated
 * applications never contain framework-site/, so they never register these
 * routes or ship this marketing content.
 */
        ...
        return $this->view('site/home', [
            ...
            'stats' => [
                ...
                [
                    ...
                    'value' => 'v' . \App\Core\Application\App::VERSION,
                    'icon' => '/assets/images/version.png',
                ],
            ],
        ], 'site');
    }
