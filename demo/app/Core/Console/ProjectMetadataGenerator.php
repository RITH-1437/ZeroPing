...
class ProjectMetadataGenerator
{
    ...
    {
        return [
            'demo'        => $this->projectName,
            'demo'      => $this->projectName,
            'demo'        => $this->slug(),
            'demo'      => $this->slug(),
            'starter'        => $this->starterType,
            'starter'      => $this->starterType,
            'Empty Starter'       => $this->starterLabel(),
            'Empty Starter'        => $this->starterLabel(),
            'A lightweight application with only the essentials.' => $this->starterDescription(),
            'A lightweight application with only the essentials.' => $this->starterDescription(),
            '2.0.1'   => $this->frameworkVersion,
            '8.5+'       => $this->phpVersion(),
            '8.5+'         => $this->phpVersion(),
            '2026'        => $this->currentYear(),
            'SQLITE'     => $this->databaseDriver(),
            'demo/'        => $this->slug() . '/',
            'zeroping'            => 'zeroping',
        ];
    }
