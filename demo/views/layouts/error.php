...
$homeUrl = rtrim((string) ($_ENV['APP_URL'] ?? 'http://127.0.0.1:1437'), '/');
...
<head>
    ...
    <title><?= htmlspecialchars((string) $code, ENT_QUOTES) ?> &middot; <?= htmlspecialchars($title, ENT_QUOTES) ?> â€” ZeroPing</title>
    <style>
        :root {
            --bg: #070b14;
            --bg-soft: #0d1424;
            ...
            <div class="zp-debug" id="zp-debug">
                ...
                <div class="zp-debug-body">
                    <div class="row">
                        ...
                        <span class="v"><?= htmlspecialchars($exception ?: 'â€”', ENT_QUOTES) ?></span>
                    </div>
                    <div class="row">
                        <span class="k">Message</span>
                        <span class="v"><?= htmlspecialchars($message ?: 'â€”', ENT_QUOTES) ?></span>
                    </div>
                    <div class="row">
                        <span class="k">File</span>
                        <span class="v"><?= htmlspecialchars($file ?: 'â€”', ENT_QUOTES) ?>:<?= htmlspecialchars((string) $line, ENT_QUOTES) ?></span>
                    </div>
                    <div class="row">
