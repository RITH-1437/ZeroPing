    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .badge {
            ...
            color: #86efac; background: rgba(34,197,94,.08); border: 1px solid rgba(34,197,94,.25);
            margin-bottom: 16px;
        }
        .desc {
        ...
        .actions { display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin-bottom: 28px; }
        .btn {
        ...
        .btn-outline {
            flex: 1 1 140px; text-decoration: none; font-size: 14px; font-weight: 600;
...
<body>
    <main class="wrap">
        ...
        <span class="badge">Empty Skeleton</span>

        <p class="desc">
            Your project is ready. A clean slate &mdash; build anything from here.
        </p>
        ...
        <section class="stats" aria-label="Runtime information">
            ...
            <div class="stat">
                ...
                <span class="stat-value"><?= htmlspecialchars(ucfirst(config('app.env', 'local')), ENT_QUOTES) ?></span>
            </div>
        </section>
        ...
        <nav class="actions" aria-label="Getting started">
            ...
            <a class="btn-outline" href="https://github.com/RITH-1437/ZeroPing">GitHub</a>
        </nav>
